...
const PATHS = {
  ...
  /* Medalha: usada nos prêmios */
  award: (
    <>
      <circle cx="12" cy="9" r="5.5" />
      <path d="M12 6.6l1.15 2.3 2.55.35-1.85 1.8.45 2.55L12 12.4l-2.3 1.2.45-2.55L8.3 9.25l2.55-.35L12 6.6Z" />
      <path d="M8.5 14.2 7 21l5-2.4 5 2.4-1.5-6.8" />
    </>
  ),
